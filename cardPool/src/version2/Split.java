...
public class Split 
{
    ...
    public String processPart2(long start, long end, LinkedBlockingQueue<Card> pool, String databaseName)
            throws Exception
        {
        	String[] input = null;
    		String line = null;	String name = null;	String attribute = null;	String type = null;
    ...
    public String processPartDraft2(long start, long end, LinkedBlockingQueue<Card> pool, String databaseName)
            throws Exception
        {
        	String[] input = null;
    		String line = null;	String name = null;	String attribute = null;	String type = null;
            ...
            //FileInputStream database = new FileInputStream(file);
    		//BufferedReader databaseStream = new BufferedReader(new InputStreamReader(database));
    		InputStream database = getClass().getResourceAsStream(databaseName);
			BufferedReader databaseStream = new BufferedReader(new InputStreamReader(database));
    		database.skip(start);
            long chunkSize = startingSize / (end - start);
            long bytesRead = 0;
    ...
    public Callable<String> processPartTaskDraft(final long start, final long end, LinkedBlockingQueue<Card> pool, String databaseName) {
        return new Callable<String>() {
            public String call()
                throws Exception
            {
                return processPartDraft2(start, end, pool, databaseName);
            }
        };
    }
    ...
    public void processAllDraft(int noOfThreads, int chunkSize, LinkedBlockingQueue<Card> pool, int trip, String databaseName)
            throws Exception
        {
    	//System.out.println(chunkSize);
            ...
            for(int i = 0; i < count; i++)
            { tasks.add(processPartTaskDraft(i * chunkSize, Math.min(startingSize, (i+1) * chunkSize), pool, databaseName)); }
